...
b) Generalise the function so that it takes two arguments: the vector \texttt{xVec} and an integer k
which lies between 1 and n − 1 where n is the length of \texttt{xVec}.
